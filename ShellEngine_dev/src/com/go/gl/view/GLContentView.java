...
import com.go.gl.animator.ValueAnimator.AnimationHandler;
...
import com.go.gl.util.FastQueue.Processor;
import com.go.gl.util.FpsCounter;
import com.go.gl.util.NdkUtil;
import com.go.gl.view.GLView.AttachInfo;
...
public class GLContentView extends GLSurfaceView implements GLViewParent {
	...
	public static com.go.gl.util.Log sLog = new com.go.gl.util.Log("ShellEngine");
...
//		Log.d("DWM", "============requestChildRectangleOnScreen " + rectangle);
	...
	private void performTraversals() {
		...
		try {
			...
			mDrawingTime += uptime - mLastUptime;
			//mDrawingTime = uptime;
			mAttachInfo.mDrawingTime = mDrawingTime;
//			AnimationUtils.sDrawingTime = mDrawingTime;
...
//			Log.d("DWM", "draw===================v " + mAttachInfo.mDrawingTime + " duration=" + ((uptime - mLastUptime)));
			mCanvas.mDeltaDrawingTime = uptime - mLastUptime;
