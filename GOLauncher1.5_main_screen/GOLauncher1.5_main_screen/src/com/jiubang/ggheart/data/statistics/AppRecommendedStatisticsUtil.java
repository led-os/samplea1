...
public class AppRecommendedStatisticsUtil implements IStatistics {
	...
	public final static byte ENTRY_TYPE_APPFUNC_BAR = 23; // 功能表操作栏
	...
	@Override
	public void saveUpdataClick(Context context, String packageName, int appid, int times, String icaburl) {
	}
