...
public class AppManagementStatisticsUtil implements IStatistics {
	...
	@Override
	public void saveUpdataClick(Context context, String packageName, int appid, int times, String iCbUrl) {
		...
		if (times != 0) {
			...
			InstallCallbackManager.saveCallbackUrl(packageName, iCbUrl);
		}
	}
