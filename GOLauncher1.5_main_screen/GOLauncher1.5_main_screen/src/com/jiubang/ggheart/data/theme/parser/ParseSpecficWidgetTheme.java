...
public class ParseSpecficWidgetTheme extends IParser {
	public static final String WIDGET_PREVIEW = "theme_preview";
	public static final String NEW_WIDGET_PREVIEW = "theme_new_preview";
	public static final String WIDGET_TITLE = "theme_title";
			...
			while (xmlPullParser.next() != XmlPullParser.END_DOCUMENT) {
				...
				if (attrName.equals(WIDGET_STYLE)) {
					...
					continue;
						...
						|| attrName.equals(NEW_WIDGET_PREVIEW)
						|| attrName.equals(WIDGET_TITLE)
