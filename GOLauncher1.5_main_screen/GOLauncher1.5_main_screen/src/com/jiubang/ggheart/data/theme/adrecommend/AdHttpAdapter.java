...
public class AdHttpAdapter {
	...
	public static boolean sIsShowDefaultListDialog = true;
	
	private static String sAdHttpUrl = LauncherEnv.Server.AD_HTTP_URL_PRO;
	static {
		if (ServerUtils.isUseTestServer(LauncherEnv.Server.AD_HTTP_CONFIG_USE_TEST_SERVER)) {
			sAdHttpUrl = LauncherEnv.Server.AD_HTTP_URL_SIT;
		}
	}
