...
public class AppSettingTable {
	...
	public final static String ICON_EFFECT_FOR_3D = "iconeffectfor3d";
	...
	final static String THEME_PACKAGE_NAME = IGoLauncherClassName.DEFAULT_THEME_PACKAGE;
	public final static String INSERTAPPSETTINGVALUES = "insert into " + AppSettingTable.TABLENAME
			...
			+ AppSettingDefault.APPFUNC_COLNUM + ", " + AppSettingDefault.DISABLEUPDATEAPP + ", "
