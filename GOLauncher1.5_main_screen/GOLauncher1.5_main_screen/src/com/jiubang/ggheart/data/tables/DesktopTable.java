...
public interface DesktopTable {
	 ...
	 *  是否开启快捷栏
	 */
	static public String ENABLESIDEDOCK = "enablesidedock";

	/**
	 * 侧边栏方向
	 */
	static public String SIDEDOCKPOSITION = "sidedockposition";
	
	/**
	 * 新布局
	 */
	static public String ENABLEMARGINS = "enablemargins";
	...
	static public String CREATETABLESQL = "create table desktop " + "("
			...
			+ "fontsize numeric, " + "customtitlecolor numeric, " + "enablesidedock numeric, " + "enablemargins numeric, "
			+ "sidedockposition numeric, " + "titlecolor numeric" + ")";
}
