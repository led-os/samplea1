...
public class AppFuncSettingTable {
	...
	public static int getKeyByColumnName(String columnName) {
		...
		if (AppSettingTable.ICON_EFFECT_FOR_3D.equals(columnName)) {
			return Setting.ICON_EFFECT_FOR_3D;
		}
		return -1;
	}
	...
	public static void initDefaultDatas(SQLiteDatabase db) {
		String pkName = IGoLauncherClassName.DEFAULT_THEME_PACKAGE;
		...
		insertData(db, pkName, AppSettingTable.PROUPDATEAPP,
				String.valueOf(AppSettingDefault.DISABLEUPDATEAPP));
		...
		insertData(db, pkName, AppSettingTable.ICON_EFFECT_FOR_3D,
				String.valueOf(AppSettingDefault.ICONEFFECT));
	}
