...
public interface ScreenSettingTable {
	...
	/**
	 * 表字段：功能表指示器位置 top/bottom 类型：top屏幕顶部/ bottom屏幕底部
	 */
	static public String APPDRAWERINDICATORPOSITION = "appdrawerindicatorposition";
	/**
	 * 表语句
	 */
	static public String CREATETABLESQL = "create table screensetting " + "("
			...
			+ "appdrawerindicatorposition text " + ")";
}
