...
public interface ICustomAction {
	...
	/**获取内测数据*/
	public final static String ACTION_BETA_NORMAL_INTERVAL = "com.jiubang.intent.action.BETA_NORMAL_INTERVAL";
	
	public final static String ACTION_BETA_CHECK_TIME = "com.jiubang.intent.action.BETA_CHECK_TIME";
	
	public final static String ACTION_BETA_CHECK_TIME_INTERVAL = "com.jiubang.intent.action.BETA_CHECK_TIME_INTERVAL";
	...
	/**提示用户卸载不常用应用*/
	public final static String ACTION_NOTIFY_UNINSTALL = "com.jiubang.intent.action.NOTIFY_UNINSTALL";
	...
	/**GO备份推荐下载图标*/
	public final static String ACTION_RECOMMAND_GOBACKUP_DOWNLOAD = "com.jiubang.intent.action.DOWNLOAD_GOBACKUPPRO";
	...
	public static String MAIN_NEXTWIDGET_PACKAGE = "com.gtp.nextlauncher.widget";
	public static String GOBACKUP_GOWIDGET_PACKAGE = "com.jiubang.go.backup.ex"; // go备份widget的包名
	...
	/**百度省电图标,桌面图标*/
	//public static final String ACTION_DESK_SHOW_BAIDU_BATTERYSAVER = "com.jiubang.intent.aciton_BAIDU_BATTERYSAVER";
	...
	/**美化中心action*/
	public static final String KITTYPLAY_ACTION = "com.jiubang.go.gomarket.appgame_MAIN.cosplay";
