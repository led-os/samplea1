...
public class GoStorePublicDefine {
	...
	public static String sUrlHost3 = LauncherEnv.Server.GO_STORE_BASE_HOSTURL_PRO;   //目前使用的正式服务器地址

//	public static final String URL_HOST3_TEST = "http://gotest.3g.net.cn/gostore/entrance";

//		public static final String URL_HOST3 = "http://192.168.214.238:8080/gostore/entrance";    //贤钹机子
...
//		public static final String URL_HOST3 = "http://61.145.124.70:8081/gostore/entrance";	//测试服务器地址
	...
	//	public static final String URL_HOST3 = "http://176.34.62.53:80/gostore/entrance";		//国外地址2
	...
	public static final String SCAN_IMAGE_AD_ID_KEY = "scan_image_ad_id_key";
...
//	public static final String ACTION_ACTIVITY_FINISH = "com.jiubang.ggheart.apps.gowidget.gostore.ACTIVITY_FINISH";
	...
	static {
		if (ServerUtils.isUseTestServer(LauncherEnv.Server.GO_STORE_CONFIG_USE_TEST_SERVER)) {
			sUrlHost3 = LauncherEnv.Server.GO_STORE_BASE_HOSTURL_SIT;
		}
	}
}
