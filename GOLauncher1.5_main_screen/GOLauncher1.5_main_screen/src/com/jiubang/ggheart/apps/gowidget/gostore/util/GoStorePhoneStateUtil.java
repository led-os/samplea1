...
public class GoStorePhoneStateUtil {
	...
	public static String getVirtualIMEI(Context context) {
		...
		class Statistics {
			...
			private void saveDeviceIdToSharedpreference(Context context, long deviceId) {
				...
				pref.putString(PrefConst.KEY_RANDOM_DEVICE_ID, device);
				pref.commit();
			}
	...
	public static String getGoStoreUid(Context context) {
		...
		// 从资源获取流
		gostoreUid = FileUtil.getShortStrDataFromRaw(context, R.raw.gostore_uid);
		if (gostoreUid == null) {
			gostoreUid = GoStoreChannelControl.GOSTORE_DEFAULT_CHANNEL;
		}
		return gostoreUid;
	}
	...
	public static boolean isWifiEnable(Context context) {
		return Machine.isWifiEnable(context);
	}
	...
	public static String isRoot(Context context) {
		...
		class Root {
			...
			private void saveRootInfoToSharedpreference(Context context, String rootInfo) {
				...
				pref.putString(PrefConst.KEY_ROOT_INFO_DATA, device);
				pref.commit();
			}

			private String getRootInfoFromSharedpreference(Context context) {
				PrivatePreference pref = PrivatePreference.getPreference(context);
				return pref.getString(PrefConst.KEY_ROOT_INFO_DATA, "");
			}
