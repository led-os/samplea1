		...
		if (mRecommAppCtgList != null && !mRecommAppCtgList.isEmpty()) {
			synchronized (mRecommAppCtgList) {
				if (mRecommAppCtgList != null) {
					...
					//					IDownloadService downloadManager = DownloadControllerProxy.getInstance().getDownloadController();
					//					String iconUrl = null;
...
//	}
	...
	public boolean handleMessage(Object who, int msgId, int param, Object ...obj) {
		...
		//				break;
			case IAppManagerMsgId.APPS_MANAGEMENT_RECOMMENDED_APP :
				if (mRecommAppCtgList != null && !mRecommAppCtgList.isEmpty()) {
					mUpdateListBeans = (ArrayList<AppBean>) obj[1];
					if (mLoadIconEnd) {
						setUpdateStatus();
					}
