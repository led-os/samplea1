...
public class FunAppSetting {
	...
	public static final int FUNC_APP_TYPE_FREETHEME = 3;
	...
	public static final String FUNC_APP_FREETHEME_ISSHOW = "FUNC_APP_FREETHEME_ISSHOW";
	/**
	 * 是否显示功能表资源管理按钮
	 */
	...
	private void initTaskManagerWidgetNotify() {
		...
		if (mObserver != null) {
			removeFunAppSettingObserver(mObserver);
		}
		...
		addFunAppSettingObserver(mObserver);
	}
	 ...
	 *            观察者
	 */
	public void addFunAppSettingObserver(ISettingObserver iSettingObserver) {
	 ...
	 * @param iSettingObserver
	 */
	public void removeFunAppSettingObserver(ISettingObserver iSettingObserver) {
		if (this.mISettingObservers == null) {
			return;
		}
	 ...
	 * 通知观察者
	 */
	private void notifyObservers(int index, int value, Object object) {
	...
	public void setMenuAppStyle(int menuAppStyle) {
		// 主题不相关，直接操作默认主题的设置
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.MENUAPPSTYLE,
				Integer.toString(menuAppStyle));

		// 通知观察者
		notifyObservers(INDEX_MENUAPPSTYLE, menuAppStyle, null);
	}

	private int getValueFromDefaultThemePakage(int id, int defaultValue) {
		String str = getAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, id,
	...
	public void setAppFuncSetting(String pkname, int key, String value) {
		setAppFuncSettingBinder(pkname, key, value);
	}

	public String getAppFuncSetting(String pkname, int key, String defaultValue) {
		String value = getAppFuncSettingBinder(pkname, key);
		if (value == null) {
			value = defaultValue;
		}
		return value;
	...
	public void setInOutEffect(int inOutEffect) {
		...
		// 主题不相关，直接操作默认主题的设置
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.INOUTEFFECT,
				Integer.toString(inOutEffect));

		// 通知观察者
		notifyObservers(INDEX_INOUTEFFECT, inOutEffect, null);
	}

	public int getIconEffect() {
		return getValueFromDefaultThemePakage(Setting.ICON_EFFECT_FOR_3D,
	...
	public void setIconEffect(int iconEffect) {
		...
		if (EffectorControler.getInstance().getEffectorInfoById(iconEffect).mIsBothSupprot) { // 判断特效2D桌面是否支持，不支持则不保存更改（可能是3D特有特效）
			// 主题不相关，直接操作默认主题的设置
			setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE,
					Setting.ICONEFFECT, Integer.toString(iconEffect));
		}
		// 主题不相关，直接操作默认主题的设置
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.ICON_EFFECT_FOR_3D,
				Integer.toString(iconEffect));

		// 通知观察者
		notifyObservers(INDEX_ICONEFFECT, iconEffect, null);
	}
	...
	public void setTurnScreenDirection(int turnScreenDirection) {
		// 主题不相关，直接操作默认主题的设置
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.TURNSCREENDIRECTION,
				Integer.toString(turnScreenDirection));

		// 通知观察者
		notifyObservers(INDEX_TURNSCREENDIRECTION, turnScreenDirection, null);
	}
	...
	public int getBgSetting() {
		...
		if (null != themeBean) {
			...
			// 默认主题
			str = getAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.BGVISIABLE, null);
		}
	...
	public String getTabHomeBgSetting() {
		...
		if (null != themeBean) {
			...
			// 默认主题
			str = getAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.TAB_HOME_BG, null);
		}
	...
	public String getIndicatorSetting() {
		...
		if (null != themeBean) {
			...
			// 默认主题
			str = getAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.INDICATOR_STYLE,
					null);
		}
	...
	public void setIndicatorSetting(String style) {
		...
		if (null != themeBean) {
			...
			// 默认主题
			setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.INDICATOR_STYLE, style);
		}

		themeBean = null;
		MsgMgrProxy.sendBroadcastHandler(this, IAppDrawerMsgId.APPDRAWER_INDICATOR_THEME_CHANGE, -1,
				null, null);
	...
	public void setTabHomeBgSetting(String packageName) {
		...
		if (null != themeBean) {
			...
			// 默认主题
			setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.TAB_HOME_BG, packageName);
		}
		themeBean = null;
		MsgMgrProxy.sendHandler(this, IDiyFrameIds.APP_DRAWER,
				IAppDrawerMsgId.APPDRAWER_TAB_HOME_THEME_CHANGE, -1, null, null);
		// 通知观察者
		// notifyObservers(INDEX_BGSWITCH, bgVisiable, null);
		notifyObservers(INDEX_TAB_BOTTOM_BG, -1, null);
	}
	...
	public void setBgSetting(int bgVisiable) {
		...
		if (null != themeBean) {
			...
			// 默认主题
			setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.BGVISIABLE,
					Integer.toString(bgVisiable));
		}
		themeBean = null;
	...
	public void setSortType(int sortType, final boolean notify) {
		// 主题不相关，直接操作默认主题的设置
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.SORTTYPE,
				Integer.toString(sortType));

		if (notify) {
			// 通知观察者
			notifyObservers(INDEX_SORTTYPE, sortType, null);
		}
	}
	...
	public void setShowNeglectApp(int showNeglectApp) {
		// 主题不相关，直接操作默认主题的设置
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.SHOWNEGLECTAPP,
				Integer.toString(showNeglectApp));

		// 通知观察者
		notifyObservers(INDEX_SHOWNEGLECTAPP, showNeglectApp, null);
	}
	...
	public void setAppNameVisiable(int appNameVisiable) {
		// 主题不相关，直接操作默认主题的设置
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.APPNAMEVISIABLE,
				Integer.toString(appNameVisiable));

		// 通知观察者
		notifyObservers(INDEX_APPNAMEVISIABLE, appNameVisiable, null);
	}
	...
	public void setShowSearch(int isShow) {
		// 主题不相关，直接操作默认主题的设置
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.SHOW_SEARCH,
				Integer.toString(isShow));

		// 通知观察者
		notifyObservers(INDEX_SHOW_SEARCH, isShow, null);
	}
	...
	public void setAppUpdate(int isShow) {
		// 主题不相关，直接操作默认主题的设置
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.APPUPDATE,
				Integer.toString(isShow));

		// 通知观察者
		notifyObservers(INDEX_APP_UPDATE, isShow, null);
	}
	...
	public int getAppUpdate() {
		return getValueFromDefaultThemePakage(Setting.APPUPDATE, AppSettingDefault.DISABLEUPDATEAPP);
	}
	...
	public int getLineColumnNum() {
		...
		// if (null == themeBean) {
		// // 默认主题
		// str = getAppSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE,
	...
	public void setLineColumnNum(int lineColumnNum) {
		...
		// if (null == themeBean) {
		// // 默认主题
		// setAppSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE,
		...
		// }
		// 主题无关: 只修改默认主题
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.LINECOLUMNNUM,
				Integer.toString(lineColumnNum));

		// 通知观察者
		notifyObservers(INDEX_LINECOLUMNNUM, lineColumnNum, null);
	}
	...
	public void setRowNum(int row) {
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.APPFUNC_ROWNUM,
	...
	public void setColNum(int col) {
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.APPFUNC_COLNUM,
	...
	public String getBackgroundPicPath() {
		...
		if (null != themeBean) {
			...
			// 默认主题
			str = getAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.BACKGROUNDPICPATH,
					null);
		}
	...
	public void setBackgroundPicPath(String backgroundPicPath) {
		...
		if (null != themeBean) {
			...
			// 默认主题
			setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.BACKGROUNDPICPATH,
					backgroundPicPath);
		}
		themeBean = null;

		// 通知观察者
		notifyObservers(INDEX_BACKGROUNDPICPATH, 0, backgroundPicPath);
	}
	...
	public void checkAppSetting() {
		...
		// 初始设置
		if (null != themeBean) {
			addAppFuncSettingBinder(mThemeManager.getCurThemePackage());			
		} else {
			addAppFuncSettingBinder(IGoLauncherClassName.DEFAULT_THEME_PACKAGE);
		}
		themeBean = null;
	}
	...
	public void setScrollLoop(int scrollLoop) {
		// 主题不相关，直接操作默认主题的设置
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.SCROLL_LOOP,
				Integer.toString(scrollLoop));

		// 通知观察者
		notifyObservers(INDEX_SCROLL_LOOP, scrollLoop, null);
	}
	...
	public int getBlurBackground() {
		...
		if (null != themeBean) {
			...
			// 默认主题
			str = getAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.BLUR_BACKGROUND,
					null);
		}
		themeBean = null;

		// String str = getAppSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE,
	...
	public void setBlurBackground(int blur) {
		...
		if (null != themeBean) {
			...
			// 默认主题
			setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.BLUR_BACKGROUND,
					Integer.toString(blur));
		}
		themeBean = null;
		// // 主题不相关，直接操作默认主题的设置
		...
		// 通知观察者
		notifyObservers(INDEX_BLUR_BACKGROUND, blur, null);
	}
	...
	public void setShowTabRow(int showTabRow) {
		// 主题不相关，直接操作默认主题的设置
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.SHOW_TAB_ROW,
				Integer.toString(showTabRow));

		// 通知观察者
		notifyObservers(INDEX_SHOW_TAB_ROW, showTabRow, null);
	}
	...
	public void setVerticalScrollEffect(int effect) {
		...
		// 主题不相关，直接操作默认主题的设置
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.VERTICAL_SCROLL_EFFECT,
				Integer.toString(effect));

		// 通知观察者
		notifyObservers(INDEX_VERTICAL_SCROLL_EFFECT, effect, null);
	}
	...
	public void setShowGoStoreAndGoTheme(boolean show, int type) {
		...
		} else if (type == FUNC_APP_TYPE_GOWIDGET) {
			preferences.putBoolean(FUNC_APP_GOWIDGET_ISSHOW, show);
		} else if (type == FUNC_APP_TYPE_FREETHEME) {
			preferences.putBoolean(FUNC_APP_FREETHEME_ISSHOW, show);
		}
		preferences.commit();
	}
	...
	public boolean getShowGoStoreAndGoTheme(int type) {
		...
		if (type == FUNC_APP_TYPE_GOSTORE) {
			...
			return preferences.getBoolean(FUNC_APP_FREETHEME_ISSHOW, true);
		} else {
			return false;
		}
	}
	...
	public int[] getAppCustomRandomEffect(int id) {
		int[] effects = null;
		String value = getAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, id, null);
		if (value != null) {
	...
	public void setAppCustomRandomEffect(int[] effects, int id) {
		...
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, id, buffer.toString());
	}
	...
	public void setShowActionBar(int flag) {
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.SHOW_ACTION_BAR,
				Integer.toString(flag));

		// 通知观察者
		notifyObservers(INDEX_SHOW_ACTION_BAR, flag, null);
	}
	...
	public void setShowHomeKeyOnly(int flag) {
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.SHOW_HOME_KEY_ONLY,
				Integer.toString(flag));

		// 通知观察者
		notifyObservers(INDEX_SHOW_HOME_KEY_ONLY, flag, null);
	}
	...
	public void resetFuncBgObserver() {
		...
		notifyObservers(INDEX_BGSWITCH, BG_DEFAULT, null);
	}
	...
	public String getImageOpenWay() {
		return getAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.IMAGE_OPEN_WAY,
	...
	public String getAudioOpenWay() {
		return getAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.AUDIO_OPEN_WAY,
				MediaManagementOpenChooser.APP_NONE);
	}
	...
	public void setImageOpenWay(String value) {
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.IMAGE_OPEN_WAY, value);
	...
	public void setAudioOpenWay(String value) {
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.AUDIO_OPEN_WAY, value);
	}
	...
	public void setGlideUpAction(int value) {
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.ENABLE_GLIDE_UP_ACTION,
				String.valueOf(value));
		// 通知观察者
		notifyObservers(INDEX_GLIDE_UP_ACTION, value, null);
	}
	...
	public int getGlideUpAction() {
		...
		//		int result = OFF;
		//		try {
		//			result = Integer.parseInt(getAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE,
	...
	public void setGlideDownAction(int value) {
		setAppFuncSetting(IGoLauncherClassName.DEFAULT_THEME_PACKAGE, Setting.ENABLE_GLIDE_DOWN_ACTION,
				String.valueOf(value));
		// 通知观察者
		notifyObservers(INDEX_GLIDE_DOWN_ACTION, value, null);
	}
	...
	private void addAppFuncSettingBinder(String pkgName) {		
		boolean ret = SettingProxy.addAppFuncSettingBinder(pkgName);
		if (!ret) {
			mDataModel.addAppFuncSetting(pkgName);
		}
	}
	
	private String getAppFuncSettingBinder(String pkname, int key) {
		String value = SettingProxy.getAppFuncSettingBinder(pkname, key);
		if (null == value) {
			value = mDataModel.getAppFuncSetting(pkname, key);
		}
		
		return value;
	}
	
	private void setAppFuncSettingBinder(String pkname, int key, String value) {
		boolean ret = SettingProxy.setAppFuncSetting(pkname, key, value);
		if (!ret) {
			mDataModel.setAppFuncSetting(pkname, key, value);
		}
	}
	
	public FunSettingBean getDefaultData() {
		return new FunSettingBean(IGoLauncherClassName.DEFAULT_THEME_PACKAGE);
	}
	...
	public class FunSettingBean {
		private HashMap<Integer, String> mCurPkgSettingBean;
		
		public FunSettingBean(String pkgName) {
			// TODO Auto-generated constructor stub
			mCurPkgSettingBean = mDataModel.getAppFuncSettings(pkgName);
		}
		
		private int getValue(int key, int defaultValue) {
			String valueStr = mCurPkgSettingBean.get(key);
			int value = defaultValue;
			try {
		...
		public int getLineColumnNum() {
			return getValue(Setting.LINECOLUMNNUM, AppSettingDefault.LINECOLUMNNUM);
		}

		public int getTurnScreenDirection() {
			return getValue(Setting.TURNSCREENDIRECTION, AppSettingDefault.TURNSCREENDIRECTION);
		}
		
		public int getAppNameVisiable() {
			return getValue(Setting.APPNAMEVISIABLE, AppSettingDefault.APPNAMEVISIABLE);
		}
		
		public int getInOutEffect() {
			return getValue(Setting.INOUTEFFECT, AppSettingDefault.INOUTEFFECT);
		}
		
		public int getIconEffect() {
			return getValue(Setting.ICON_EFFECT_FOR_3D, AppSettingDefault.ICONEFFECT);
		}
		
		public int getSortType() {
			return getValue(Setting.SORTTYPE, AppSettingDefault.SORTTYPE);
		}
		
		public int getScrollLoop() {
			return getValue(Setting.SCROLL_LOOP, AppSettingDefault.SCROLL_LOOP);
		}
		
		public int getShowTabRow() {
			return getValue(Setting.SHOW_TAB_ROW, AppSettingDefault.SHOW_TAB_ROW);
		}
		
		public int getShowSearch() {
			return getValue(Setting.SHOW_SEARCH, AppSettingDefault.APP_SEARCH_VISIABLE);
		}

		public int getAppUpdate() {
			return getValue(Setting.APPUPDATE, AppSettingDefault.DISABLEUPDATEAPP);
		}

		public int getVerticalScrollEffect() {
			return getValue(Setting.VERTICAL_SCROLL_EFFECT, AppSettingDefault.VERTICAL_SCROLL_EFFECT);
		}

		public int getShowHomeKeyOnly() {
			return getValue(Setting.SHOW_HOME_KEY_ONLY, AppSettingDefault.SHOW_HOME_KEY_ONLY);
		}

		public int getShowActionBar() {
			return getValue(Setting.SHOW_ACTION_BAR, AppSettingDefault.SHOW_ACTION_BAR);
		}

		public int getGlideUpAction() {
			return getValue(Setting.ENABLE_GLIDE_UP_ACTION, OFF);
		}
		
		public int getGlideDownAction() {
			return getValue(Setting.ENABLE_GLIDE_DOWN_ACTION, OFF);
		}
