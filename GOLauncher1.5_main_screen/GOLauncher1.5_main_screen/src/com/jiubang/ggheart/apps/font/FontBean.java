 ...
 * @date  [2013-7-3]
 */
public class FontBean extends BroadCaster implements BroadCaster.BroadCasterObserver, Parcelable {
	/**
	 * 系统字体
	 */
	...
	public static final Parcelable.Creator<FontBean> CREATOR = new Parcelable.Creator<FontBean>() {
		@Override
		public FontBean createFromParcel(Parcel source) {
			// 从Parcel中读取数据，返回DownloadTask对象
			return new FontBean(source);
		}

		@Override
		public FontBean[] newArray(int size) {
			return new FontBean[size];
		}
	};
	...
	public FontBean(Parcel in) {
		mFontFileType = in.readInt();
