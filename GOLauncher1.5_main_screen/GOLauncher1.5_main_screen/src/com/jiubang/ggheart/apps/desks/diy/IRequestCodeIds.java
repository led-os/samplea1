...
public interface IRequestCodeIds {
	 ...
	 * 操作设置－》打开手势－》应用程序
	 */
	public final static int REQUEST_OPERATION_PINCHOUT_GESTURE_OPEN_APP = 410;

	/**
	 * 操作设置－》双指上划手势－》应用程序
	 */
	public final static int REQUEST_OPERATION_SWIPEUP_GESTURE_OPEN_APP = 411;

	/**
	 * 操作设置－》逆时针手势－》应用程序
	 */
	public final static int REQUEST_OPERATION_ROTATECCW_GESTURE_OPEN_APP = 412;

	/**
	 * 操作设置－》顺时针手势－》应用程序
	 */
	public final static int REQUEST_OPERATION_ROTATECW_GESTURE_OPEN_APP = 413;
	 ...
	 * 请求修改文件夹
	 */
	public final static int REQUEST_MODIFY_FOLDER = 700;
	
	/**
	 * 设置默认桌面
	 */
	public final static int REQUEST_SET_DEFAULT_HOME = 701;
	
	public final static int BIND_SYSTEM_WIDGET = 702;
	
	public static final int REQUEST_CODE_BACKUP_SETTING = 703;
	
	public final static int REQUEST_CODE_COOLPAD_CLEARDEFAULT = 704;
	
	public final static int REQUEST_CODE_LOCK = 705;
	
	public final static int REQUEST_CODE_COMMON_SETTING = 706;
	
	public final static int REQUEST_CODE_ADVANCED_SETTING = 707;
	
	public final static int REQUEST_CODE_FONT_SETTING = 708;
}