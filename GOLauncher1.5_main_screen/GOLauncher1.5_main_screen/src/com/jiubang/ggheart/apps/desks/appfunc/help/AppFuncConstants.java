...
public class AppFuncConstants {
	...
	public static enum MessageID {
		...
		HIDE_APPS, ADD_ITEM, ADD_ITEMS, REMOVE_ITEM, REMOVE_ITEMS, REFREASH_APPDRAWER,
		REFREASH_FOLDERBAR_TARGET, 
		SHOW_APP_UPDATE_CHANGE, // 是否显示程序更新图标
		SHOW_ACTION_BAR_CHANGE, // 是否显示底部栏改变
		SHOW_HOME_KEY_ONLY_CHANGE, // 是否只显示home键改变
		TAB_BOTTOM_BG_CHANGE, // tab栏底部栏背景改变
		FIRST_INIT_DONE , // 功能表完全加载完成
		RELOAD_INIT_DONE,
		ARRANGE_END
	}
	...
	public static final int ALL_APP_MENU_BE_OPEN = 76; // 功能表所有程序菜单被打开
	...
	public static final int APPFOLDER_AD_GRID = 10; // 文件夹广告对应的Grid
