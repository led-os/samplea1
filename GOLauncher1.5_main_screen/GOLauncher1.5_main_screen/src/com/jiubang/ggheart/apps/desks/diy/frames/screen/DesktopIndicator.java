 ...
 * 
 */
public class DesktopIndicator extends ViewGroup implements AnimationListener, Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 123232L; //实现 Serializable，尝试解决 DROID RAZR 系列 ClassCastException 问题
	...
	private void initIndicator(Context context) {
		try {
			...
			mDotIndicatorHeight = 32;
			mSliderIndicatorHeight = 32;
		}
		...
		if (processName != null && processName.equals(LauncherEnv.PROCESS_NAME)) { // 主进程中才应用主题，这里牵扯到访问DB，多个进程访问DB会造成DB lock
			// 加载主题
			applyTheme();
		}
	...
	public void applyTheme() {
		...
		String indicatorMode = ThemeManager.getInstance(ApplicationProxy.getContext())
