...
public class DeskSettingQaGoLauncherView extends LinearLayout implements ScreenScrollerListener {
	...
	private String reLengthText(String text) {
	...
	private void initTab() {
		...
		String text = getContext().getString(R.string.desk_setting_performance);
		titleList.add(reLengthText(text));
		text = getContext().getString(R.string.desk_setting_optesthesia);
		titleList.add(reLengthText(text));
		text = getContext().getString(R.string.desk_setting_operate);
		titleList.add(reLengthText(text));
	...
	public void onScrollChanged(int newScroll, int oldScroll) {
		...
		int scrollX = newScroll - mScrollerViewGroup.getCurrentViewIndex()
				* GoLauncherActivityProxy.getScreenWidth();
		final int width = GoLauncherActivityProxy.getScreenWidth();
