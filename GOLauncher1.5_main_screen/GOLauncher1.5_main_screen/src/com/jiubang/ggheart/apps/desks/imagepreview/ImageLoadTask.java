...
public abstract class ImageLoadTask<Params, Progress, Result> {
			...
			protected void done() {
				...
				try {
					...
					message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
							new PreReadTaskResult<Result>(ImageLoadTask.this, (Result[]) null));
				...
				message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
						new PreReadTaskResult<Result>(ImageLoadTask.this, result));
				message.sendToTarget();
			}
		};
	}
	 ...
	 */
	public final ImageLoadTask<Params, Progress, Result> execute(Params... params) {
	...
	protected final void publishProgress(Progress... values) {
		sHandler.obtainMessage(MESSAGE_POST_PROGRESS, new PreReadTaskResult<Progress>(this, values))
				.sendToTarget();
	}
	...
	private static class PreReadTaskResult<Data> {
		final ImageLoadTask mTask;
		final Data[] mData;

		PreReadTaskResult(ImageLoadTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
