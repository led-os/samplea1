...
public class ScreenEditSkinMenu implements ICleanable {
	...
	private static final float HDPI_WIDGET_SCALE = 0.47f;
 ...
 */
	...
	public void show(View view) {
		...
		int marginRight = DrawUtils.dip2px(0);
		int marginBottom;
...
//							R.dimen.screen_edit_box_container_gowidgets);
			marginBottom = DrawUtils.sHeightPixels - (int) (DrawUtils.sHeightPixels * HDPI_WIDGET_SCALE);
