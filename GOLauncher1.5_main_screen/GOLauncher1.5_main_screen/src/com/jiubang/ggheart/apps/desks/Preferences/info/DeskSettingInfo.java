...
public class DeskSettingInfo {
	...
	private DeskSettingClassifyInfo mClassifyInfo; //分类选择框
	...
	public void setClassifyInfo(DeskSettingClassifyInfo classifyInfo) {
		mClassifyInfo = classifyInfo;
	}
	
	public DeskSettingClassifyInfo getClassifyInfo() {
