...
public class CustomIconUtil {
	...
	public static Intent getCropImageIntent(Context context, Intent intent, int frameid) {
		...
		switch (frameid) {
			...
			case DOCK_BG :
				try {
					String saveFileString = DockLogicControler.getDockBgSaveFilePath(ThemeManager.getInstance(ApplicationProxy.getContext()).getCurThemePackage());
				...
				// final int bgId = GoLauncherLogicProxy.isLargeIcon() ?
