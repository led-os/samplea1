...
//		ScreenFrame screenFrame = (ScreenFrame) FrameControl.getFrameStatic(IDiyFrameIds.SCREEN_FRAME);
//		if (screenFrame == null) {
//			return;
//		}
		...
		findViewById(R.id.folder_indicator).setVisibility(View.GONE);
	...
	private class MyAdapter extends MutilCheckViewAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (info instanceof ShortCutInfo) {
				...
				if (SettingProxy.getDesktopSettingInfo().isShowTitle()) {
					textView.setText(((ShortCutInfo) info).mTitle);
				}
