...
public class BackUpSettingReceiver extends BroadcastReceiver {
	...
	// 备份桌面
	public static final String BACKUP_DB = "com.jiubang.goback.backup_db";
	// 无法完成备份
	private final String EXPORT_ERROR = "com.jiubang.goback.export_error";
	// 备份成功
	public static final String EXPORT_SUCCESS = "com.jiubang.goback.export_success";
	// 恢复备份成功
	...
	// 备份/恢复命令
	public static  final String BACKCMD = "com.jiubang.goback.backCMD";
	// 备份路径
	public static final String BACKPATH = "com.jiubang.goback.backPath";
	// 随机字符串
	private final String RANDOMSTR = "com.jiubang.goback.randomStr";
	// 返回的备份信息
	public static final String BACKINFO = "com.jiubang.goback.backInfo";
	//是否备份目录下所有DB
	public static final String BACKALL = "com.jiubang.goback.backall";
	// base64算法的key值
	...
	private boolean mBackAllFiles = false;
	// GO备份广播的action
...
//	public static final String ACTION_BACKUP = "com.jiubang.go.backup.ACTION_BACKUP_GOLAUNCHER_FINISH";
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (backCmd.equals(BACKUP_DB)) {
			...
			mBackAllFiles = intent.getBooleanExtra(BACKALL, false);
			BackupDB(backPath);
		}
		// 恢复桌面
	...
	private class ExportDatabaseTask extends AsyncTask<String, Void, String[]> {
		...
		protected void onPostExecute(final String[] result) {
			if(result != null && result.length == 2){
				...
				intent.putExtra(BACKINFO, result[0]);
				intent.putExtra(RANDOMSTR, randomsrc);
				intent.putExtra(BACKPATH, result[1]);
