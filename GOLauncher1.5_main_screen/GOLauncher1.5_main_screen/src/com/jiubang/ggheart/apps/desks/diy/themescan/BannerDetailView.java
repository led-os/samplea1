...
public class BannerDetailView extends RelativeLayout implements View.OnClickListener {
	...
	public void refrash() {
		mBannerThemeContainer.updateState(ThemeContainer.STATE_NET_LOADFINISHED);
	}
	...
	private void initThemeContainer() {
		...
		RelativeLayout.LayoutParams relativeLayoutParams = new RelativeLayout.LayoutParams(
				...
				RelativeLayout.LayoutParams.MATCH_PARENT);
		this.addView(mBannerThemeContainer, relativeLayoutParams);
	}
	...
	private void setMyBackground(Drawable drawable) {
		...
		if (mBackground == null || mBackground.getIntrinsicWidth() != mWidth
				|| mBackground.getIntrinsicHeight() != mHeight) {
			mBackground = (BitmapDrawable) drawable;
			mBackground.setTileModeXY(TileMode.REPEAT, TileMode.REPEAT);
		}
		if (mBackground != null) {
			mBannerThemeContainer.setBackgroundDrawable(mBackground);
		}
	}
...
//		mBannerThemeContainer.refreshListView();
	}
}
