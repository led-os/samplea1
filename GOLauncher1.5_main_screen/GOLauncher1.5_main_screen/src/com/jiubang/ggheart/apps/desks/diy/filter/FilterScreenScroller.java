...
import com.go.util.scroller.MScroller;
 ...
 * 
 */
public class FilterScreenScroller extends MScroller {
...
//	protected float mPaddingFactor = 0.5f;
	protected float mPaddingFactor = 0f;
	...
	protected boolean mScrollOnlyLastTOPre;        //半循环,从后往前
	 ...
	 * @param screenGroup
	 */
	public FilterScreenScroller(Context context, ScreenScrollerListener screenGroup) {
	...
	public void setScrollOnlyLastToPre(boolean onlyLastToPre) {
		mScrollOnlyLastTOPre = onlyLastToPre;
	}
...
//				if (DrawUtils.sVirtualDensityDpi != -1 && DrawUtils.sDensityDpi != DrawUtils.sVirtualDensityDpi) {
//					mBitmap.setDensity(DrawUtils.sDensityDpi);
//				}
				mBackgroundWidth = mBitmap.getWidth();
				mBackgroundHeight = mBitmap.getHeight();
			}
			setBackgroundOffsetY();
...
//		}
	 ...
	 * @param newScroller
	 */
	private static void copyScrollerAttributes(FilterScreenScroller scroller, FilterScreenScroller newScroller) {
		...
		newScroller.setScrollOnlyLastToPre(scroller.mScrollOnlyLastTOPre);
	}
