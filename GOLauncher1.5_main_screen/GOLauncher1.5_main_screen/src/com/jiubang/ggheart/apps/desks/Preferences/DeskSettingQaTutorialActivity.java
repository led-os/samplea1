...
//	private DialogSingleChoice mOperateAlertDialog; //操作提示对话框
	...
	public void goToOperateTips(int item) {
		...
		switch (item) {
			case 0 : {
				GoLauncherLogicProxy.setTutorialMask(LauncherEnv.MASK_TUTORIAL_CUSTOM_GESTURE);
				break;
			}
			case 1 : {
				...
				GuideControler.sNeedShowPreviewGuide = true;
				GoLauncherLogicProxy.setTutorialMask(LauncherEnv.MASK_TUTORIAL_PREVIEW);
				break;
			}
			case 2 : {
				GoLauncherLogicProxy.setTutorialMask(LauncherEnv.MASK_TUTORIAL_DOCK_BAR_ICON);
				break;
			}
		}
		Intent intent = new Intent();
		intent.setClassName(DeskSettingQaTutorialActivity.this, IGoLauncherClassName.GOLAUNCHER_ACTIVITY);
