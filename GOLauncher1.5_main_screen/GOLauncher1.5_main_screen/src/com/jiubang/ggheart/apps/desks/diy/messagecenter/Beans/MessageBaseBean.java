...
public class MessageBaseBean {
	...
	public static final int TYPE_INSTRUCT = 6; //指令消息
	public static final int TYPE_SUPER_THEME = 8; //指令消息
	/**
	 * 展现方式(int)
	...
	*/
	...
	public static final String TAG_MSG_IS_WIFI = "iswifi";

	public static final String TAG_MSG_OUT_DATE = "end_time"; //消息结束时间

	public static final String TAG_MSG_COUPONLIST = "yhjs"; //优惠劵数组
	public static final String TAG_MSG_COUPON_CODE = "ycode"; //优惠劵码
	public static final String TAG_MSG_COUPON_VALUE = "yvalue"; //优惠劵面值
	public static final String TAG_MSG_COUPON_PERIOD = "period"; //优惠劵有效天数
	public static final String TAG_MSG_COUPON = "yhj"; //优惠券

	public static final String TAG_MSG_PROMOTIONLIST = "cxj"; //促销卷
	public static final String TAG_MSG_PROMOTION_CODE = "ccode"; //优惠劵码
	public static final String TAG_MSG_PROMOTION_STIME = "stime"; //促销开始时间 2013-05-08 12:00:00
	public static final String TAG_MSG_PROMOTION_ETIME = "etime"; //促销结束时间 2013-05-08 24:00:00
	//因为以上的促销时间被优惠卷(的时间)这边占用，所以需要重新定义促销卷的时间
	public static final String TAG_MSG_NEW_PROMOTION_STIME = "stime"; //促销开始时间
    public static final String TAG_MSG_NEW_PROMOTION_ETIME = "etime"; //促销结束时间
	
	public static final String TAG_MSG_INSTRUCT = "instruct"; //指令类型
	
	public static final String TAG_MSG_PACKAGENAME = "packagename"; //推广的是第三方应用
	public static final String TAG_MSG_MAPID = "mapid"; //统计id
	public static final String TAG_MSG_ADDACT = "addact";
	public static final String TAG_MSG_ISADV = "isadv";
	public static final String TAG_MSG_IMGURL = "msgimgurl";
	/**
	 * 在ftp下载动作规则中
	...
	*/
	...
	public String mCoupon; //优惠劵
	public String mPromotion; //促销卷
	public String mInstruct; //指令类型
	public String mPackageName; //第三方推荐包名
	public String mMapId; //统计id
	public int mAddact; //是否弹出付费引导
	public int mIsadv; //是否为广告 4.15新增
