...
public class DeskSettingVisualIndicatorTabView extends DeskSettingVisualAbsTabView {
	...
	//private DeskSettingItemListView mAppDrawerPosition; //功能表指示器位置
	...
	protected void findView() {
		...
		//mAppDrawerPosition = (DeskSettingItemListView) findViewById(R.id.app_drawer_position);
		//mAppDrawerPosition.setOnValueChangeListener(this);
	...
	public void save() {
		...
		/*String appDrawerIndicatorposition = mAppDrawerPosition.getDeskSettingInfo().getSingleInfo()
				.getSelectValue();*/
		...
		// 功能表设置指示器位置
		/*if (!mScreenInfo.mAppDrawerIndicatorPosition.equals(appDrawerIndicatorposition)) {
			mScreenInfo.mAppDrawerIndicatorPosition = appDrawerIndicatorposition;

			//3D插件
			MsgMgrProxy.sendMessage(this, IDiyFrameIds.APP_DRAWER,
					IAppCoreMsgId.INDICATOR_CHANGE_POSITION, -1, appDrawerIndicatorposition, null);
