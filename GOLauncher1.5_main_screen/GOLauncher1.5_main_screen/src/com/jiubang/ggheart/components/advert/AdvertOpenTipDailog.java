...
//		log3("isLauncherTop:" + isLauncherTop);
		//判断是否在屏幕层
		if (isLauncherTop) {
			final AppItemInfo appItemInfo = AppDataEngine.getAppName(this, packageName);	//获取包命对应的程序信息
			...
			dialog.setPositiveButton(R.string.ok, new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					MsgMgrProxy.sendMessage(this, IDiyFrameIds.SCHEDULE_FRAME, ICommonMsgId.START_ACTIVITY, -1, appItemInfo.mIntent, null);
					AdvertOpenTipDailog.this.finish();
				}
			});
