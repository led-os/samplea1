...
public interface IQuickActionId {
	...
	public static final int APPLY = 113;
	public static final int EDIT = 114;
	public static final int RENAME_FOLDER = 115; //文件夹重命名(气泡框)
	// dock menu
	public static final int CHANGE_SHORTCUT_DOCK = 200;
	public static final int CHANGE_ICON_DOCK = 201;
	public static final int CHANGE_GESTURE_DOCK = 202;
	public static final int ADD_FOLDER_DOCK = 203;
}
