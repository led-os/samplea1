 ...
 * 
 */
public class RenameActivity extends DialogActivity implements OnTouchListener, OnClickListener {
	...
	public void onConfigurationChanged(Configuration newConfig) {
		...
		if (mFinishWhenChangeOrientation) {
			...
			limitDialogLayout(mContentView);
		}
	}
	...
	private void findViews() {
		...
		mContentView = (RelativeLayout) findViewById(R.id.contentview);
		limitDialogLayout(mContentView);
	}
