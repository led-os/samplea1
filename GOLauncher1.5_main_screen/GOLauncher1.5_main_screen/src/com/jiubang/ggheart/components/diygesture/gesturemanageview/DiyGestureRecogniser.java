...
public class DiyGestureRecogniser extends Activity
	...
	public void initResultListView() {
		...
		mResultListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				readyPopupDialog(mResultAdapterData.get(position));
	...
	public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
		...
		if (size == 0) {
			...
			int screenwidth = GoLauncherActivityProxy.getScreenWidth();
			Rect rect = new Rect(screenwidth / 2, screenheight, screenwidth / 2, screenheight);
			readyPopupDialog(diyGestureInfo);
	...
	private void readyPopupDialog(DiyGestureInfo diyGestureInfo) {
		if (FunctionPurchaseManager.getInstance(getApplicationContext()).getPayFunctionState(
				...
				&& DeskSettingUtils.getGesturePrimeDialogPreference(this, 305) != DeskSettingUtils.CONDITION_PASS_HAD_SHOW) {
			DeskSettingUtils.setGesturePrimeDialogPreference(this, 305,
