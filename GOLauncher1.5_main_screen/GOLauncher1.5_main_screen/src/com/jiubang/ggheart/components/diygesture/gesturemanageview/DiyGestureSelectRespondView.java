...
public class DiyGestureSelectRespondView extends LinearLayout {
	...
	private static final int DIALOG_TYPE_APP = 0; // 应用程序
	private static final int DIALOG_TYPE_GOSHORTCUT = 1; // GO快捷方式
	private static final int DIALOG_TYPE_SHORTCUT = 2; // 系统快捷方式
