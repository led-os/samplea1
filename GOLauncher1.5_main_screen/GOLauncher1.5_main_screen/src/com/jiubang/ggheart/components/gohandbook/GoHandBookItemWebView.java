...
public class GoHandBookItemWebView extends LinearLayout {
	...
	private DeskButton mRefreshBtn; // 刷新按钮
	...
	private DeskTextView mProgressNow; //当前进度提示
	...
	public GoHandBookItemWebView(Context context, String keyName, int currentPage, int openPage) {
		...
		mProgressNow = (DeskTextView) findViewById(R.id.progress_now);
		...
		mRefreshBtn = (DeskButton) findViewById(R.id.refreshBtn);
