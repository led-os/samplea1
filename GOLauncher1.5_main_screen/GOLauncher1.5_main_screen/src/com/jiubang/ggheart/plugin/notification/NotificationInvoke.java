...
public class NotificationInvoke {
	...
	public static void startGmailMonitor(Context context) {
		try {
			...
			String name = pref.getString(PrefConst.KEY_ACCOUNT,
					null);
			String pwsd = pref.getString(PrefConst.KEY_PASSWORD, null);
			if (name != null && pwsd != null) {
				bundle.putString(PrefConst.KEY_ACCOUNT, name);
				bundle.putString(PrefConst.KEY_PASSWORD, pwsd);
