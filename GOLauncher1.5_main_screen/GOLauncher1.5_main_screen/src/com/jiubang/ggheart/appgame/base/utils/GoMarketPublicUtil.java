...
public class GoMarketPublicUtil {
	...
	private boolean mIsNeedQuixey = false;
...
//	public static final String AF_SECRET_KEY = "CEYlzHV2359L50f790c0";
	...
	public void setIsNeedQuixey(boolean show) {
		try {
			PreferencesManager preferences = new PreferencesManager(mContext,
					IPreferencesIds.GOMARKET_PUBLIC_UTIL, Context.MODE_WORLD_READABLE);
			preferences.putBoolean("quixey", show);
			preferences.commit();
		} catch (Exception e) {
			// TODO: handle exception
		}
	...
	public boolean getIsNeedQuixey() {
		mIsNeedQuixey = true;
		try {
			PreferencesManager preferences = new PreferencesManager(mContext,
					IPreferencesIds.GOMARKET_PUBLIC_UTIL, Context.MODE_WORLD_READABLE);
			mIsNeedQuixey = preferences.getBoolean("quixey", true);
		} catch (Exception e) {
			// TODO: handle exception
		}
		return mIsNeedQuixey;
	}
