...
public class EmptyContainer extends FrameLayout implements IContainer, IModeChangeListener {
	...
	public void onVisible(boolean isVisible) {
		if (isVisible) {
			if (mRealContainer instanceof GridViewContainer) {
				((GridViewContainer) mRealContainer).onVisible(isVisible);
			} else if (mRealContainer instanceof NewExtraContainer) {
				((NewExtraContainer) mRealContainer).onVisible(true);
			} else if (mRealContainer instanceof FeaturedContainer) {
				((FeaturedContainer) mRealContainer).onVisible(true);
			}
		}
	}
