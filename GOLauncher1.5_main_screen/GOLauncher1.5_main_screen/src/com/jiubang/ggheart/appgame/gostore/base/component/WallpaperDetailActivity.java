...
public class WallpaperDetailActivity extends Activity
	...
	public static final String TYPID = "typeid";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ApplicationProxy.getContext().startService(
...
//				resetDownloadBtn();
	...
	public void downloadPicture() {
		...
		RealTimeStatisticsUtil.upLoadDownloadStaticData(mContext,
				...
				String.valueOf(mTypeid), mPosition + 1,
				"");
