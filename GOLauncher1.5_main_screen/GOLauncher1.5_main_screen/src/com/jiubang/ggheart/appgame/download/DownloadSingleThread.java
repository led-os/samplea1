...
public class DownloadSingleThread extends Thread {
	...
	private HttpURLConnection openConnection(String downloadUrl) throws Exception {
		...
		if (GoStorePhoneStateUtil.getNetWorkType(ApplicationProxy.getContext()) != GoStorePhoneStateUtil.NETTYPE_UNICOM
				&& ThemeHttp.isCWWAPConnect(ApplicationProxy.getContext())) {
			Proxy proxy = null;
