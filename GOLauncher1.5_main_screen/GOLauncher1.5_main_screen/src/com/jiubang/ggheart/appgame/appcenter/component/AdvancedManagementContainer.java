...
public class AdvancedManagementContainer extends RelativeLayout implements IContainer {
	 ...
	 * Go备份跳转电子市场url
	 */
	public static final String OPERATOR_GOBACKUP_URL = "market://details?id=com.jiubang.go.backup.ex&referrer=utm_source%3DAppcenter_manager%26utm_medium%3DHyperlink%26utm_campaign%3DAppcenter_manager";
	/**
	 * Go备份跳转电子市场url
	 */
	public static final String OPERATOR_GOBACKUP_PKGNAME = "com.jiubang.go.backup.ex";
...
//		mBeanList.add(beanOrders);
		...
		if (!GoAppUtils.isAppExist(mContext, OPERATOR_GOBACKUP_PKGNAME)) {
			// Go备份
			AdvanceManagementBean beanBackup = new AdvanceManagementBean();
			beanBackup.mIcon = getResources().getDrawable(
					R.drawable.appcenter_icon_gobackup);
			beanBackup.mName = getResources().getString(
					R.string.appcenter_advanced_management_gobackup);
			beanBackup.mOperator = AdvanceManagementBean.OPERATOR_GOBACKUP;
			mBeanList.add(beanBackup);
		}
...
//				mContext.startActivity(intent);
				AppsManagementActivity.sendMessage(this,
						...
						IAppManagerMsgId.SHOW_PACKAGE_MANAGEMENT_VIEW, -1, null, null);
				break;
			case AdvanceManagementBean.OPERATOR_APP_MOVE :
				...
				AppsManagementActivity.sendMessage(null,
						IDiyFrameIds.APPS_MANAGEMENT_MAIN_VIEW_FRAME,
						IAppManagerMsgId.SHOW_APP_MIGRATION_VIEW, -1, null, null);
				break;
			case AdvanceManagementBean.OPERATOR_ORDERS_MANAGEMENT :
				// 订单管理
				break;
			case AdvanceManagementBean.OPERATOR_GOBACKUP:
				GoStoreOperatorUtil.gotoMarket(mContext, OPERATOR_GOBACKUP_URL);
				break;
			default :
				break;
		}
	...
	private class AdvanceManagementBean {
		 ...
		 * 操作：Go备份
		 */
		public static final int OPERATOR_GOBACKUP = 104;
	}
