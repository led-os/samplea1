...
public class AppsNetConstant {
	...
	// 主题Icon动态更换接口协议版本号
	public static final int THEME_ICON_UPDATE_PVERSION = 1;
	
	public static String sAppCenterUrlChina = LauncherEnv.Server.APP_CENTER_URL_CHINA_PRO; // 应用中心国内域名正式服务器地址

	public static String sAppCenterUrlOthers = LauncherEnv.Server.APP_CENTER_URL_OTHERS_PRO; // 应用中心国外域名正式服务器地址
...
//		public static final String APP_CENTER_URL_OTHERS = "http://183.61.112.38:8080";
	...
	// Go推荐Widget地址路径
	public static final String GO_RECOMM_WIDGET_URL = "/recommendedapp/remdinfo.do?rd=";
	/**
	 * 应用中心国内心跳包地址
	 */
	...
	static {
		if (ServerUtils.isUseTestServer(LauncherEnv.Server.APP_CENTER_CONFIG_USE_TEST_SERVER)) {
			sAppCenterUrlChina = LauncherEnv.Server.APP_CENTER_URL_CHINA_SIT;
			sAppCenterUrlOthers = LauncherEnv.Server.APP_CENTER_URL_OTHERS_SIT;
		}
	}
}